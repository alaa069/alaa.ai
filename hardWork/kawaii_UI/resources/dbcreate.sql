...
CREATE SEQUENCE public.responses_response_post_id_seq
INCREMENT 1
START 1
MINVALUE 1
MAXVALUE 9223372036854775807
...
CREATE TABLE public.responsesPOST
(
  intent_id integer NOT NULL,
  agent_id integer NOT NULL,
  response_text character varying COLLATE pg_catalog."default",
  response_name character varying COLLATE pg_catalog."default",
  response_url character varying COLLATE pg_catalog."default",
  response_header_username character varying COLLATE pg_catalog."default",
  response_header_password character varying COLLATE pg_catalog."default",
  response_header_key0 character varying COLLATE pg_catalog."default",
  response_header_value0 character varying COLLATE pg_catalog."default",
  response_header_key1 character varying COLLATE pg_catalog."default",
  response_header_value1 character varying COLLATE pg_catalog."default",
  response_header_key2 character varying COLLATE pg_catalog."default",
  response_header_value2 character varying COLLATE pg_catalog."default",
  response_type integer REFERENCES response_type (response_type_id),
  response_id integer NOT NULL DEFAULT nextval('responses_response_post_id_seq'::regclass)
)
WITH (
  OIDS = FALSE
)
