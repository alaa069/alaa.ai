...
import kawaii_nlu
from kawaii_nlu import components
...
from kawaii_nlu.utils import create_dir
...
class Metadata(object):
    ...
    def persist(self, model_dir):
        ...
        metadata.update({
            ...
            "kawaii_nlu_version": kawaii_nlu.__version__,
        })
...
class Trainer(object):
    ...
    def __init__(self, config, component_builder=None, skip_validation=False):
        # type: (KawaiiNLUConfig, Optional[ComponentBuilder], bool) -> None
...
class Interpreter(object):
    ...
    def load(model_metadata, config, component_builder=None, skip_valdation=False):
        # type: (Metadata, KawaiiNLUConfig, Optional[ComponentBuilder], bool) -> Interpreter
