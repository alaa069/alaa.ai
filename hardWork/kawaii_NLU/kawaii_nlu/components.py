...
from kawaii_nlu.training_data import Message

if typing.TYPE_CHECKING:
    from kawaii_nlu.training_data import TrainingData
...
def _read_dev_requirements(file_name):
    ...
    try:
        ...
        req_lines = pkg_resources.resource_string("kawaii_nlu", "../" + file_name).split("\n")
...
def validate_requirements(component_names, dev_requirements_file="dev-requirements.txt"):
    ...
    from kawaii_nlu import registry
...
class Component(object):
    ...
    def create(cls, config):
        # type: (KawaiiNLUConfig) -> Component
    ...
    def train(self, training_data, config, **kwargs):
        # type: (TrainingData, KawaiiNLUConfig, **Any) -> None
...
class ComponentBuilder(object):
    ...
    def create_component(self, component_name, config):
        # type: (Text, KawaiiNLUConfig) -> Component
